...
print("Destroyr's initial position: \(destroyer.position)")
print("Destroyer's new position after moving right: \(destroyer.position)")
...
//Falcon does not have a weapon property.
...
print("Destroyer's initial remaining firepower: \(destroyer.remainingFirePower)")
print("Remaining firepower after firing once: \(destroyer.remainingFirePower)")
print("Remaining firepower after firing twice: \(destroyer.remainingFirePower)")
print("Remaining firepower after firing thrice: \(destroyer.remainingFirePower)")
/*:
