...
let somePlace = GPS(latitude: 51.514004, longititude: 0.125226)
print("Latitude: \(somePlace.latitude)")
print("Longitude: \(somePlace.longititude)")
...
let favoriteBook = Book(tittle: "Deah Note", author: "'Tsugumi Ohba'", pages: 200, price: 10.99)
...
let officeLaptop = Laptop(yearPurchased: 15, repairCount: 1, yearPurchased: 2019)
print(" My Laptop - Screen Size: \(myLaptop.screenSize), Repair Count: \(myLaptop.repairCount), Year Purchased: \(myLaptop.yearPurchased)")
print("Office Laptop - Screen size: \(officeLaptop.screenSize), Repair Count: \(officeLaptop.repairCount), Year Purchased: \(officeLaptop.yearPurchased)")
/*:
